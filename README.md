...
## Accessing S1 SLC on AWS (South and Southeast Asia, Taiwan, Korea and Japan)

We ingest Sentinel-1A/B Level-1 Interferometric Wideswath(IW) SLC over the following region of interest:
<p align="center">
<img src="https://github.com/earthobservatory/sentinel1-opds/blob/master/misc/opendatasetaoi2.png" width="650">
</p>
...
Each S1 SLC scene’s directory includes:
 ...
 ### Download Scripts
 The following are some example scripts for accessing and batch downloading from `sentinel1-slc-seasia-pds`:
 
 - [sentinel_query_download](https://github.com/ericlindsey/sentinel_query_download) - Batch download from AWS, querying ASF endpoint
 - [aws_get_s1.py](https://github.com/earthobservatory/sentinel1-opds/tree/master/misc/aws_get_s1.py) - Multi-threaded download
